 ...
 * ## Implementation
 *
 * 1. Query PostgreSQL for active endpoint filters
...
impl FilterManager {
    ...
    pub async fn new(pool: PgPool, refresh_interval_secs: u64) -> Result<Self> {
    ...
    ///
    /// Queries PostgreSQL for all active endpoints and builds unified filter.
