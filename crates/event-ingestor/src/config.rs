        ...
        let chains = vec![
            ChainConfig {
                ...
                ws_url: env::var("ETHEREUM_WS_URL")
                    .context("ETHEREUM_WS_URL not set")?,
            ...
            ChainConfig {
                ...
                chain_id: 42161,
                ws_url: env::var("ARBITRUM_WS_URL")
                    .context("ARBITRUM_WS_URL not set")?,
                max_reconnect_attempts: 10,
                reconnect_delay_secs: 1,
            },
            ChainConfig {
                ...
                chain_id: 10,
                ws_url: env::var("OPTIMISM_WS_URL")
                    .context("OPTIMISM_WS_URL not set")?,
                max_reconnect_attempts: 10,
                reconnect_delay_secs: 1,
            },
            ChainConfig {
                name: "Base".to_string(),
                chain_id: 8453,
                ws_url: env::var("BASE_WS_URL")
                    .context("BASE_WS_URL not set")?,
                max_reconnect_attempts: 10,
                reconnect_delay_secs: 1,
            },
        ];
