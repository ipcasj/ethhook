...
mod tests {
    ...
    async fn test_cache_lookup() {
        ...
        let endpoint = Endpoint {
            ...
            timeout_seconds: 30,
            is_active: true,
            health_status: ethhook_domain::endpoint::HealthStatus::Healthy,
        ...
        ENDPOINT_CACHE.insert("0x1234".to_string(), vec![endpoint.clone()]);

        // Test lookup
        let result = get_matching_endpoints("0x1234");
